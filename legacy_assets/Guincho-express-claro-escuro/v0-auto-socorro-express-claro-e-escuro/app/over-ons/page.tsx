      ...
      <footer className="bg-[#012a64] border-t border-[#011d47] py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div>
              <h3 className="text-2xl font-bold text-[#ffffff] mb-4">BeautifulRims</h3>
              <p className="text-[#d4d4e8] leading-relaxed">
            ...
            <div>
              <h4 className="text-lg font-semibold text-[#ffffff] mb-4">Sitemap</h4>
              <ul className="space-y-2">
                <li>
                  <Link href="/diensten" className="text-[#d4d4e8] hover:text-[#B22234] transition-colors">
                    Services
                  </Link>
                </li>
                <li>
                  <Link href="/projecten" className="text-[#d4d4e8] hover:text-[#B22234] transition-colors">
                    Projects
                  </Link>
                </li>
                <li>
                  <Link href="/over-ons" className="text-[#d4d4e8] hover:text-[#B22234] transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-[#d4d4e8] hover:text-[#B22234] transition-colors">
                    Contact
                  </Link>
                </li>
                <li>
                  <a
                    ...
                    className="text-[#d4d4e8] hover:text-[#B22234] transition-colors"
                  >
                    Marketplace
                  </a>
                </li>
            ...
            <div>
              <h4 className="text-lg font-semibold text-[#ffffff] mb-4">Contact Information</h4>
              <div className="space-y-2 text-[#d4d4e8]">
                <p>
                  <span className="font-semibold text-[#ffffff]">Address:</span>
                  <br />
                  Mockstreet 10
                  <br />
                  1010MM Mocktown
                ...
                <p>
                  ...
                  <br />
                  <a href="mailto:beautifulrims@outlook.com" className="hover:text-[#B22234] transition-colors">
          ...
          <div className="border-t border-[#011d47] mt-8 pt-8 text-center text-[#a8a8c0]">
